...
public class UpdateConnectorRvEntry extends ObligationProcessorBase {
  ...
  public void processObligation(EventProcessingObligation obligation, ChangeEvent event, Callback cb) {
    ...
    idStore.updateConnectorRvEntry(null, event.getConnector(), event.getLocalObj(), event.getRemoteObj(), event.getChangeType());
