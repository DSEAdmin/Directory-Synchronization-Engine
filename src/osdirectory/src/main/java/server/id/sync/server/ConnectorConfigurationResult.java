...
public class ConnectorConfigurationResult {
  private long version;
  private Result result;
  private String errorString;
  
  public ConnectorConfigurationResult(ConnectorConfigurationResponse response) {
   version = response.getVersion();
   result = Result.valueOf(response.getResult().name());
   errorString = response.getErrorString();
  }

  public ConnectorConfigurationResult(Result result, String error) {
    this.version = 1;
    this.result = result;
    this.errorString = error;
  }
  
  public ConnectorConfigurationResponse getConnectorConfigurationResponse() {
